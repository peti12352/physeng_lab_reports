...
\begin{frame}{Outline}
    \begin{itemize}
        \item \textbf{Theory}: Vanadium Dioxide (VO2) Physics
        \item \textbf{Methods}: Measurement Setup and Objectives
        \item \textbf{Results}:
        \begin{itemize}
            \item Voltage-Induced Switching (I-V)
            \item Thermal Phase Transition (R-T)
            \item Relaxation Dynamics (Oscillatory Behavior)
        \end{itemize}
        \item \textbf{Conclusion}: Impact and Future Outlook
    \end{itemize}
\end{frame}
