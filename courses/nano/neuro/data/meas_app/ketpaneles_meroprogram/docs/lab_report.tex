...
\end{figure}
 ...
 The zoomed-in view confirms that the current spike at \SI{\sim 100}{\micro\second} is a direct response to an input voltage pulse.
...
We were expecting to observe a refractory period, where the neuron does not respond to a stimulus and the voltage drops below the baseline (Yi \ref{sec:bib}). We observed it once, but we could not reproduce it, as the memristor got damaged, and we did not properly save the data.
