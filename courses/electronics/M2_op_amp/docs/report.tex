...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\linewidth]{voltage_follower.jpg} % GGG
...
% GGG Please add the measured value for the cutoff frequency fc.
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.32\linewidth}
        \includegraphics[width=\linewidth]{diff_square.jpg} % GGG
    \end{subfigure}
    \begin{subfigure}[b]{0.32\linewidth}
        \includegraphics[width=\linewidth]{diff_triangle.jpg} % GGG
    \end{subfigure}
...
\begin{figure}[H]
    \centering
    \begin{subfigure}[b]{0.32\linewidth}
        \includegraphics[width=\linewidth]{diff_sine_no.jpg} % GGG
    \end{subfigure}
    \begin{subfigure}[b]{0.32\linewidth}
        \includegraphics[width=\linewidth]{diff_square_no.jpg} % GGG
    \end{subfigure}
    \begin{subfigure}[b]{0.32\linewidth}
        \includegraphics[width=\linewidth]{diff_triangle_no.jpg} % GGG
    \end{subfigure}
...
\begin{figure}[H]
    \centering
    \begin{subfigure}[b]{0.32\linewidth}
        \includegraphics[width=\linewidth]{int_sine_.jpg} % GGG
    \end{subfigure}
    \begin{subfigure}[b]{0.32\linewidth}
        \includegraphics[width=\linewidth]{int_square_.jpg} % GGG
    \end{subfigure}
    \begin{subfigure}[b]{0.32\linewidth}
        \includegraphics[width=\linewidth]{int_triangle_.jpg} % GGG
    \end{subfigure}
...
\begin{figure}[H]
    \centering
    \begin{subfigure}[b]{0.32\linewidth}
        \includegraphics[width=\linewidth]{int_sine_no.jpg} % GGG
    \end{subfigure}
    \begin{subfigure}[b]{0.32\linewidth}
        \includegraphics[width=\linewidth]{int_square_no.jpg} % GGG
    \end{subfigure}
    \begin{subfigure}[b]{0.32\linewidth}
        \includegraphics[width=\linewidth]{int_triangle_no.jpg} % GGG
    \end{subfigure}
