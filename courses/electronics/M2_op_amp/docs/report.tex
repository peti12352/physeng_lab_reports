...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\linewidth]{inverter_saturation.png} % 
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\linewidth]{follower_response_with_cutoff.png} 
...
\begin{figure}[H]
    \centering
    \begin{subfigure}[b]{0.32\linewidth}
        \includegraphics[width=\linewidth]{int_sine.jpg} 
    \end{subfigure}
    \begin{subfigure}[b]{0.32\linewidth}
        \includegraphics[width=\linewidth]{int_square.jpg} 
    \end{subfigure}
    \begin{subfigure}[b]{0.32\linewidth}
        \includegraphics[width=\linewidth]{int_triangle.jpg} 
    \end{subfigure}
