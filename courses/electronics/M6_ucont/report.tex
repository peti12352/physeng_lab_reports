  ...
  We experimented setting the second delay to $25,000$ which caused one of the high time to be half of its previous value. The frequency consequently increases to $f \approx 1.27\,\text{Hz}$.
  ...
  \begin{figure}[H]
    ...
    \label{fig:500hz}
  \end{figure}
  Changing $CCPR2L = 25$ reduces the high time to $201\, \mu s$ making the duty cycle 10.4\%. At the high setting ($CCPR2L = 225$) the ducty cycle was $\approx 90\%$, with a high time of $1.81\, ms$. In both cases, changing the CCPR2L did not change the total time period or frequency of the whole signal, just the duty cycle.
  ...
  To rigorize this relationship, \hyperref[tab:adc_data]{Table~\ref*{tab:adc_data}} outlines the expected data for a full sweep of the input range. When populated, this data is expected to show a linear relationship between input voltage and duty cycle, validating the linearity of the PIC18F2620's SAR converter.
